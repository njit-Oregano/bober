...
class GameBarrier
{
    ...
    public int Position
    {
        ...
        private set
        {
            ...
            Game.SetGridCell(Game.PlayerPositionX, Game.PlayerPositionY, Character.Emoji);
            CheckCollide();
            _Position = value;
        }
    }
    ...
    public void Tick()
    {
        ...
        else if (Game.CurrentGame == PossibleGames.Fly || Game.CurrentGame == PossibleGames.Home)
        {
            Position--;
        }
    }
    ...
    public void CheckCollide()
    {
        switch (Game.CurrentGame)
        {
            ...
            case PossibleGames.Home:
            case PossibleGames.Fly:
                if (Position == Game.PlayerPositionX || Position == Game.PlayerPositionX - 1)
                {
